...
export const CountdownTimer: React.FC = () => {
  ...
  return (
    <section className="py-16 px-4 relative z-10 max-w-4xl mx-auto text-center">
      ...
      >
        <div className="flex items-center justify-center gap-2 text-gold-400 text-xs uppercase tracking-[0.25em] mb-2">
          <Clock className="w-4 h-4" />
          <span>Büyük Günü Beklerken</span>
        </div>

        <h2 className="font-serif text-3xl sm:text-4xl text-neutral-100 font-light mb-8">
          Geri Sayım
        </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 max-w-2xl mx-auto">
          {timerItems.map((item, index) => (
            <motion.div
              ...
              className="flex flex-col items-center justify-center p-4 rounded-2xl bg-black/60 border border-gold-400/20 shadow-inner"
            >
